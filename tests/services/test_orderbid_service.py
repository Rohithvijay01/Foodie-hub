...
class TestOrderBidService:
    ...
    async def test_place_bid_order_not_bidding(self, repository_factory, override_dependencies):
    ...
    async def test_place_bid_order_not_found(self, repository_factory, override_dependencies):
    ...
    async def test_place_bid_already_bid(self, repository_factory, override_dependencies):
        order = SimpleNamespace(id=1, status=OrderStatus.BIDDING)
        delivery_user = SimpleNamespace(id=1, upi_screenshot_url="http://example.com/upi.jpg")
    ...
    async def test_place_bid_no_upi_screenshot(self, repository_factory, override_dependencies):
        order = SimpleNamespace(id=1, status=OrderStatus.BIDDING)
    ...
    async def test_delete_bid_not_found(self, repository_factory, override_dependencies):
    ...
    async def test_get_accepted_bid_by_order_id(self, repository_factory, override_dependencies):
    ...
    async def test_get_bids_by_delivery_user_id(self, repository_factory, override_dependencies):
        bids = [
